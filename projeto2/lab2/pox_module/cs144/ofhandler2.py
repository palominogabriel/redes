...
#Topology is fixed 
#sw0-eth1:server1-eth0 sw0-eth2:server2-eth0
...
def get_ip_setting():
  ...
  RTABLE.append( ('%s' % IP_SETTING['server3'], '%s' % IP_SETTING['server3'], '255.255.255.255', 'eth1') )
  RTABLE.append( ('%s' % IP_SETTING['server4'], '%s' % IP_SETTING['server4'], '255.255.255.255', 'eth2') )
